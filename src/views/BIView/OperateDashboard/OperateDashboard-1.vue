...
import LivePerf from '@/views/BIView/OperateDashboard/Tabs/LivePerf/LivePerfV2'
...
export default {
  ...
  created() {
    ...
    console.log(window.parent.location, window.location)
  ...
  mounted() {
    ...
    this.calcHeight = debounce(() => {
      ...
      el.style.height = `calc(100vh - ${offsetTop + 10}px)`
      el.style.setProperty('--height', el.clientHeight - 40)
      el.style.opacity = '1'
    }, 100)
    this.calcHeight()
