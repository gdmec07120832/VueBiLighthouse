<template>
  <div class="page-wrapper">
    <div class="s-board-wrapper">
      ...
      <div @click="clickCell(tabs[7])" :class="{active: curCell.title === '采购毛利'}" class="s-board">
        <div class="left">
          <p>
            <span style="position: relative">
              采购毛利率
      ...
      <div @click="clickCell(tabs[9])" :class="{active: curCell.title === '欠货概况'}"  class="s-board">
        <div class="left">
          <p>日均订单欠货</p>
          <div
            class="text-xl"
      ...
      <div @click="clickCell(tabs[11])" :class="{active: curCell.title === '库存周转'}" class="s-board">
        <div class="left">
          <p>周转率</p>
          <div
            class="text-xl"
      ...
      <div @click="clickCell(tabs[12])" :class="{active: curCell.title === '库龄滞销'}" class="s-board">
        <div class="left">
          <p>滞销金额</p>
          <div
            class="text-xl"
      ...
      <div @click="clickCell(tabs[13])" :class="{active: curCell.title === '售后不良'}" class="s-board">
        <div class="left">
          <p>售后不良率</p>
      ...
      <div @click="clickCell(tabs[14])" :class="{active: curCell.title === '客满评价'}" class="s-board">
        <div class="left">
          <p>全渠道差评率</p>
          <div
            class="text-xl"
      ...
      <div @click="clickCell(tabs[15])" :class="{active: curCell.title === 'DSR分析'}" class="s-board">
    ...
    <div class="tabs-container" ref="tabContainer" style="min-height: 535px; opacity: 0">
      ...
      <div class="tabs-content-wrapper">
        <component :is="curTab.comp || 'LivePerf'" ref="curComp"></component>
      </div>
    </div>
  </div>
</template>
...
import LivePerf from '@/views/BIView/OperateDashboard/Tabs/LivePerf/LivePerf'
import ChannelPerf from '@/views/BIView/OperateDashboard/Tabs/ChannelPerf/ChannelPerfV2'
import CirculationOverview from '@/views/BIView/OperateDashboard/Tabs/CirculationOverview/CirculationOverview'
import OrderDistribution from '@/views/BIView/OperateDashboard/Tabs/OrderDistribution/OrderDistribution'
import CompetitorAnalysis from '@/views/BIView/OperateDashboard/Tabs/CompetitorAnalysis/CompetitorAnalysis'
import NotShippedCancel from '@/views/BIView/OperateDashboard/Tabs/NotShipedCancel/NotShippedCancel'
import LogisticsShipping from '@/views/BIView/OperateDashboard/Tabs/LogisticsShipping/LogisticsShipping'
import PurchaseProfit from '@/views/BIView/OperateDashboard/Tabs/PurchaseProfit/PurchaseProfit'
import BizRefund from '@/views/BIView/OperateDashboard/Tabs/BizRefund/BizRefund'
import InventoryOnway from '@/views/BIView/OperateDashboard/Tabs/InventoryOnway/InventoryOnway'
import InventoryTurnover from '@/views/BIView/OperateDashboard/Tabs/InventoryTurnover/InventoryTurnover'
import DSRAnalysis from '@/views/BIView/OperateDashboard/Tabs/DSRAnalysis/DSRAnalysis'
import LessCargoOverview from '@/views/BIView/OperateDashboard/Tabs/LessCargoOverview/LessCargoOverview'
import CSEvaluation from '@/views/BIView/OperateDashboard/Tabs/CSEvaluation/CSEvaluation'
import BadAfterSale from '@/views/BIView/OperateDashboard/Tabs/BadAfterSale/BadAfterSale'
import StorageUnsalable from '@/views/BIView/OperateDashboard/Tabs/StorageUnsalable/StorageUnsalable'
import PromoteFeeV2 from '@/views/BIView/OperateDashboard/Tabs/PromoteFee/PromoteFeeV2'
import SetExplain from '@/views/BIView/OperateDashboard/Tabs/SetExplain/SetExplain'
...
export default {
  ...
  methods: {
    ...
    clickCell(tabItem, ext) {
      ...
      setTimeout(() => {
        Bus.$emit('tab-cell-click', this.curCell)
      }, 50)
    },
    getData1() {
