 ...
 * @LastEditTime: 2022-01-19 09:53:14
 * @LastEditors: Please set LastEditors
 * @Descripttion: 有日 月变换的日期选择器
 * @FilePath: \lsmy-bi-lighthouse-front\src\views\BIView\ProductSupply\OverseasCockpit\components\DatepickerV3.vue
-->
<template>
    <div class="datepickerV2">
        <a-select :value="dayOrMonth" @change="change" style="width: 100px;font-size: 12px" dropdownClassName="overseasCockpitDatepickerSelect">
            <a-select-option :value="index + 1" v-for="(item, index) in options" :key="index">
                {{item}}
            </a-select-option>
        </a-select>
        <!-- 日单选项 -->
