 ...
 * @LastEditTime: 2021-12-21 18:55:06
 * @LastEditors: Please set LastEditors
 * @Descripttion: 
 * @FilePath: \lsmy-bi-lighthouse-front\src\views\BIView\ProductSupply\AuditableDataDetails\components\tab4.vue
-->
<template>
    <div>
    ...
    computed: {
        tableColumns() {
            return [
                ...
                { title: '承诺发货时间', dataIndex: 'COMMIT_TIME', width: 100, ellipsis: true, sorter: true,
                    customRender: (text) => {
                ...
                { title: '合并单号', dataIndex: 'MERGE_TRADE_NO', width: 180, ellipsis: true, sorter: true,
                    customRender: (text) => {
                        return <div oncontextmenu={(e) => {this.$refs.tab.openMenu(e,text)}} title={text}>{text}</div>
                    }
                },
                ...
                { title: '业务员昵称', dataIndex: 'STAFF_NAME', width: 100, ellipsis: true, sorter: true,
                    customRender: (text) => {
                        return <div oncontextmenu={(e) => {this.$refs.tab.openMenu(e,text)}} title={text}>{text}</div>
                    }
                },
                { title: '批次单是否可货审', dataIndex: 'IF_BATCH_DLVR', width: 100, ellipsis: true, sorter: true,
                    customRender: (text) => {
                        return <div oncontextmenu={(e) => {this.$refs.tab.openMenu(e,text)}} title={text}>{text}</div>
                    }
                },
                ...
                { title: '发货业绩', dataIndex: 'PTD_SEND_AMT', width: 100, ellipsis: true, sorter: true,
                    customRender: (text) => {
                ...
                { title: '商品编码', dataIndex: 'MATERIAL_NUMBER', width: 120, ellipsis: true, sorter: true,
                    customRender: (text) => {
                        return <div oncontextmenu={(e) => {this.$refs.tab.openMenu(e,text)}} title={text}>{text}</div>
                    }
                },
                ...
                { title: '发货区', dataIndex: 'DELIVER_DISTRICT', width: 130, ellipsis: true, sorter: true,
                    customRender: (text) => {
                        return <div oncontextmenu={(e) => {this.$refs.tab.openMenu(e,text)}} title={text}>{text}</div>
                    }
                },
