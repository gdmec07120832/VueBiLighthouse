...
<template>
    <div class="top">
        ...
        <div class="content">
            <div ref="item1" @click="currentTabChange(1)" class="item">
            ...
            <div ref="item2" @click="currentTabChange(2)" class="item" style="width: 22%">
                <div class="row1">
                    <div class="icon"></div>
            ...
            <div v-if="currentView !== 3" ref="item3" @click="currentTabChange(3)" class="item" style="width: 22%">
                <div class="row1">
                    <div class="icon"></div>
            ...
            <div v-if="currentView !== 3" ref="item4" @click="currentTabChange(4)" class="item" style="width: 22%">
                <div class="row1">
                    <div class="icon"></div>
                ...
                graphic: [
                    {
                        ...
                        style: {
                            ...
                            font: '24px "PingFangSC-Medium", "PingFang SC"'
                        }
                    },
                    {
                        type: 'text',
