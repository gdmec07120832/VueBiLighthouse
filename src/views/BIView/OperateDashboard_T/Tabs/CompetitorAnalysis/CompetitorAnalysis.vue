    ...
    parseData(data) {
      ...
      Object.keys(shopMap).forEach((shop) => {
        ...
        const yoyData = Array(12)
          ...
          if(series.length>2){
            series[2].itemStyle.normal.color='#5C8FF9';
            series[1].itemStyle.normal.color='#9AC5FF';
            series[0].itemStyle.normal.color='#e7e7e7';
            series[2].areaStyle.opacity=1;
            ...
            series[1].areaStyle.opacity=0.5;
            ...
            series[0].areaStyle.opacity=0.5;
            ...
            series[1].itemStyle.normal.color='#5C8FF9';
            series[0].itemStyle.normal.color='#e7e7e7';     
            series[1].areaStyle.opacity=1;
            series[1].areaStyle.color= new graphic.LinearGradient(0, 0, 0, 1, [
              {
                offset: 0,
                // color: '#5C8FF9'
            ...
            series[0].areaStyle.opacity=0.2;
            series[0].areaStyle.color= new graphic.LinearGradient(0, 0, 0, 1, [
              {
                offset: 0,
                color: '#EDF0F4'
