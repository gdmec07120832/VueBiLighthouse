  ...
  <table class="dashboard-common-table">
    ...
    <tr>
      ...
      <td @mouseenter="mouseenter(1, (m+'月'),null)"
        ...
        {{
          formatRto(
              ((yearMonthValues[year] || [])[m - 1] || {})['DEAL_RTO']
          )
        }}
      </td>
    </tr>
    <tr>
      ...
      <td @mouseenter="mouseenter(2, (m+'月'),null)"
        ...
        {{
          formatRto(
              ((yearMonthValues[year - 1] || [])[m - 1] || {})['DEAL_RTO']
          )
        }}
      </td>
    </tr>
...
export default {
  ...
  methods: {
    calcYoy (year, m) {
      const a = this.yearMonthValues[year]?.[m]?.['DEAL_RTO']
      const b = this.yearMonthValues[year - 1]?.[m]?.['DEAL_RTO']
